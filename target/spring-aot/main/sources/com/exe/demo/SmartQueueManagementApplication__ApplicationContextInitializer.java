 ...
 */
@Generated
public class SmartQueueManagementApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SmartQueueManagementApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SmartQueueManagementApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
