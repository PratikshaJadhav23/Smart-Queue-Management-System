...
/**
 * Bean definitions for {@link CounterRepository}.
 */
@Generated
public class CounterRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'counterRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getCounterRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'counterRepository'.
   */
  public static BeanDefinition getCounterRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, CounterRepository.class, Counter.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.exe.demo.repository.CounterRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.CounterRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.exe.demo.repository.CounterRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getCounterRepositoryInstanceSupplier();
